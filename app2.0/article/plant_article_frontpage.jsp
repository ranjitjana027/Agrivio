...
<jsp:include page="/app2.0/template/layout.jsp">
  <jsp:param name="filename" value="../article/plant_article_frontpage_view.jsp"/>
  <jsp:param name="cssfile" value="/assets/css/article2.0/plant_article_frontpage.css" />
  <jsp:param name="title" value="Article | Plants" />
</jsp:include>
