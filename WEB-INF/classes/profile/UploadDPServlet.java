// compile with : javac -cp ../../../../lib/servlet-api.jar;../lib/*; profile/UploadDPServlet.java
package profile;
...
@WebServlet("/profile/upload-dp")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 10, // 10 MB
maxFileSize = 1024 * 1024 * 50, // 50 MB
maxRequestSize = 1024 * 1024 * 100) // 100 MB
public class UploadDPServlet extends HttpServlet {
					...
					if(success){
						...
						Connection con = null;
      					...
      					try{
				            ...
				            st.setString(1, "https://agrivio-assets.s3.amazonaws.com/"+uploadedFileName);
				            st.setInt(2, Integer.parseInt((String)session.getAttribute("userid")));
				            st.executeUpdate();
				            session.setAttribute("dp","https://agrivio-assets.s3.amazonaws.com/"+uploadedFileName);
