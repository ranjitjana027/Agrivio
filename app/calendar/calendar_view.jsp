...
<div class="modal" id="add-event-modal">
    <div class="modal-content" style="text-align: center;">
        ...
        <form method="POST" style="margin-bottom: 10px;">
            ...
            <div class="add-submit" style="display: inline-block;">
    ...
    <div class="modal-content" style="text-align: center;">
        ...
        <div style="display: inline-block;
            ...
            <svg height="60" width="60"
                onclick="document.querySelector('#show-event-modal').style.display='none'; document.querySelector('#add-event-modal').style.display='block';"
                style="border-radius:50%; cursor: pointer; box-shadow: 0px 2px 5px rgba(0,0,0,0.8);">
