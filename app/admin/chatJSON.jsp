...
<c:choose>
  <c:when test="${sessionScope.role=='ADMIN' or sessionScope.userid==param.room}">
    ...
    <sql:query dataSource="${connection}" var="result">
      select * from chat_messages where room=? order by c_time;
      <sql:param value="${Integer.valueOf(param.room)}"/>
    </sql:query>
    {
      "messages":[
